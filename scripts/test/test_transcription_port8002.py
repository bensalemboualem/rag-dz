#!/usr/bin/env python
"""Test transcription rapide avec modèle base - Port 8002"""
import requests
import json
import time
...
print("=" * 70)
print("TEST TRANSCRIPTION RAPIDE - MODELE BASE (Hardware-Aware)")
print("=" * 70)
...
# 3. Transcription
print("\n[3/3] Transcription en cours (modèle auto-détecté: base + int8)...")
print("Attente de la réponse du backend...")
...
if response.status_code == 200:
    ...
    # Save
    output_file = "D:/IAFactory/rag-dz/transcription_result.json"
